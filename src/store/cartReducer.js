...
import {stuffSlice} from "./inventoryReducer.js";
...
export const cartSlice = createSlice({
    ...
    reducers: {
        add_to_cart: (state, action) => {
            ...
            console.log("ADDING TO CART:", type, payload);

            let existingCartItemIndex = state.addedToCart.findIndex(item => item.item.name === payload.name);
